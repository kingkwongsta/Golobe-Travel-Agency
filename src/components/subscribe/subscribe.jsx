  ...
  return (
    <div className="flex flex-row bg-[#CDEAE1] my-[80px] mx-[80px] max-w-[1232px]">
      ...
      <div className="flex flex-col basis-[808px]">
        ...
        <p className="mb-[24px] text-[44px] font-[700] leading-[54px] text-[#112211]">
          Newsletter
        </p>
        <p className="mb-[8px] text-[700] text-[20px] leading-[25px] text-[#112211]">
          The Travel
        </p>
        <p className="mb-[16px] text-[500] text-[16px] leading-[20px] text-[#112211]">
